...
<head>
	...
	<!-- Place the page specific js here -->
        <script type="text/javascript" src="/static/js/slidingtext.js"> </script>
...
<h2>Try it out!</h2>
<ul>
	<li><a id="textup" href="javascript:;">Fold</a></li>
        <li><a id="textdown" href="javascript:;">Unfold</a></li>
        <li><a id="texttoggle" href="javascript:;">Hide</a></li>
</ul>
<p>&nbsp;</p>
