...
public class AuditoriaVistoriasTable extends Table{
	...
	public AuditoriaVistoriasTable(PromoveApplication app) {
		this.app = app;
		avariaService = ServiceFactory.getService(AvariaService.class);
		buildTable();
	}

	public AuditoriaVistoriasTable(PromoveApplication app, Veiculo veiculo) {
		this(app);
		filterTable(veiculo);
	}
...
//		addGeneratedColumn("usuario", new AvariaTableColumnGenerator(this));
	...
	class AvariaTableColumnGenerator implements Table.ColumnGenerator{
		...
		public AvariaTableColumnGenerator(AuditoriaVistoriasTable table) {
			this.table = table;
		}
	...
	class IdLinkListener implements ClickListener {
		...
		public IdLinkListener(AuditoriaVistoriasTable table) {
			this.table = table;
		}
