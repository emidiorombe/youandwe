...
public class AvariaService implements Serializable {
	...
	public List<Avaria> buscarAvariaPorFiltros(Avaria av, Date de, Date ate, Integer periodo, Boolean movimentacao, Boolean registradas, Boolean vistoriaFinal, Boolean posterior, Boolean sinistro, Boolean cancelados, OrigemAvaria oriAte, ResponsabilidadeAvaria responsabilidade, Fabricante fabricante, Usuario user) throws PromoveException {
		...
		try {
			...
			lista = avariaDAO.getAvariasPorFiltro(av, init, fim, periodo, movimentacao, registradas, vistoriaFinal, posterior, sinistro, cancelados, oriAte, responsabilidade, fabricante, user);
		} catch (DAOException e) {
			e.printStackTrace();
			throw new PromoveException(e);
		}
