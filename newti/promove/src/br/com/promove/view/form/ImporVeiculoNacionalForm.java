...
public class ImporVeiculoNacionalForm extends BaseForm{
	...
	private Upload upload = new Upload(null, new ImportNacionalUploader(this));

	public ImporVeiculoNacionalForm() {
		buildLayout();
	...
	private void buildLayout() {
		...
		Label tit = new Label("<h1>Importar Veículos Nacionais(CAOA)</h1>");
	...
	class ImportNacionalUploader implements Receiver{
		private String fileName;
        private String mtype;
		private ImporVeiculoNacionalForm view;
        
		public ImportNacionalUploader(ImporVeiculoNacionalForm view) {
			this.view = view;
		}
	...
	class UploadStartListener implements StartedListener{
		private ImporVeiculoNacionalForm view;
		public UploadStartListener(ImporVeiculoNacionalForm view ) {
			this.view = view;
		}
	...
	class UploadProgressListener implements ProgressListener{
		...
		public UploadProgressListener(ImporVeiculoNacionalForm view) {
			this.view = view;
		}
	...
	class UploadSucessListener implements SucceededListener{
		...
		public UploadSucessListener(ImporVeiculoNacionalForm view) {
			this.view = view;
		}
		...
		public void uploadSucceeded(SucceededEvent event) {
			try {
				...
				pi.setValue(100f);
				importService.importVeiculosNacionais(new String(file.toByteArray()));
	...
	class UploadFailedListener implements FailedListener{
		...
		public UploadFailedListener(ImporVeiculoNacionalForm view) {
			this.view = view;
		}
