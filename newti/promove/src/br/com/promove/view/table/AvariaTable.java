...
public class AvariaTable extends Table{
	public static final Object[] NATURAL_COL_ORDER = new Object[] {"id", "veiculo", "chassiOriginal", "modelo", "dataLancamento", "hora", "dataCadastro", "origem", "local", "tipo", "extensao", "nivel", "fotos", "clima", "usuario", "observacao"};
	public static final String[] COL_HEADERS = new String[] {"ID", "Chassi", "Chassi Original", "Modelo", "Data Lanc.", "Hora", "Data Cad.", "Local", "Peça", "Tipo", "Extensão", "Nível", "Fotos", "Clima", "Usuário", "Obs"};
	...
	public void filterTable(Veiculo veiculo) {
		try {
			...
			filterTable(avariaService.buscarAvariaPorFiltros(avaria, null, null, 1, false, false, false, null, null, null));
		} catch (Exception e) {
			e.printStackTrace();
		}
