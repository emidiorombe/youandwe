...
public class AvariaTable extends Table{
	...
	private void buildTable() {
		...
		try {
			...
			setColumnCollapsed("status", true);
	...
	public void filterTable(Veiculo veiculo) {
		...
		try {
			...
			filterTable(avariaService.buscarAvariaPorFiltros(avaria, null, null, 1, false, false, false, false, false, false, null, null, null, user));
		} catch (Exception e) {
			e.printStackTrace();
		}
